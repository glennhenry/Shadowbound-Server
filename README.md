...
Server emulator for Shadowbound, developed by R2Games, closed on 2021.

<img src="./gameplay.jpg" alt="Gameplay" width=600>
...
`docs/` directory contains technical documentation about the game.
